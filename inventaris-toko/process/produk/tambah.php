...
$stmt = $pdo->prepare(
    'INSERT INTO produk (id_kategori, nama_produk, kode_produk, harga_beli, harga_jual, stok, deskripsi)
     VALUES (?, ?, ?, ?, ?, ?, ?)'
);
$stmt->execute([$id_kategori, $nama_produk, $kode_produk ?: null, $harga_beli, $harga_jual, $stok, $deskripsi ?: null]);
